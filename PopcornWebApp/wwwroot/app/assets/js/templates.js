angular.module('popcorn').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/modules/movie/movie.html',
    ...
    "\n" +
    "                <img imagefit imagefit-option=\"vm.check\" imageonload imgloaded=\"vm.imageLoaded()\" ng-src=\"{{vm.movie.backdrop_image}}\" style=\"opacity:0.5;\">\r" +
    "\n" +
  ...
  $templateCache.put('app/modules/popular/popular.html',
    ...
    "\n" +
    "                <img ng-src=\"{{movie.large_cover_image}}\" layout-fill class=\"md-card-image\" alt=\"{{ movie.title }}\" ui-sref=\"home.movie({imdb_code: movie.imdb_code, slug: movie.slug})\">\r" +
    "\n" +
