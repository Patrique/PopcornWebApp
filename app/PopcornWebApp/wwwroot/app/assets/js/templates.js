angular.module('popcorn').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/modules/popular/popular.html',
    ...
    "                        <md-button ng-click=\"vm.toggleLike(movie)\" class=\"md-icon-button md-48\" aria-label=\"Favorite\">\n" +
    "                            <md-icon md-font-set=\"material-icons\" ng-if=\"movie.like !== true\" style=\"color:white;\">favorite</md-icon>\n" +
    "                            <md-icon md-font-set=\"material-icons\" ng-if=\"movie.like\" style=\"color:red;\">favorite</md-icon>\n" +
    "                        </md-button>\n" +
    "                    </div>\n" +
    "                </md-grid-tile-footer>\n" +
    "            </md-grid-tile>\n" +
