...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/movie/movieModule.js',
			'app/modules/movie/movieCtrl.js',
			'app/modules/movie/movieRoute.js',
			'app/modules/movie/movieService.js',
			'app/modules/movie/movie-test.js',
		],
